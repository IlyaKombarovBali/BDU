"""Translate navigable text in Java Security cheat sheet HTML fragment to Russian."""
...
SRC = ROOT / "templates" / "_owasp_java_article_extracted.html"
OUT = ROOT / "templates" / "owasp_java_security_cheat_sheet_article.html"
