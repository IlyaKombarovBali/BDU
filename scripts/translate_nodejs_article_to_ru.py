"""Translate navigable text in Node.js Security cheat sheet HTML fragment to Russian."""
...
SRC = ROOT / "templates" / "_owasp_nodejs_article_extracted.html"
OUT = ROOT / "templates" / "owasp_nodejs_security_cheat_sheet_article.html"
