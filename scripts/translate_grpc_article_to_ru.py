"""Translate navigable text in gRPC cheat sheet HTML fragment to Russian."""
...
SRC = ROOT / "templates" / "_owasp_grpc_article_extracted.html"
OUT = ROOT / "templates" / "owasp_grpc_security_cheat_sheet_article.html"
